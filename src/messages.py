...
manual_reserve_food_table_message = """سلام!
این لیست غذا‌های هفته آینده‌ی توعه. برای اینکه ررزو کنی کافیه غذا‌هایی که می‌خوای رو انتخاب کنی و آخرش حله رو بزنی تا من برات رزور کنم.
حواست باشه که هر خط مربوط به یک روز هستش و از اولین روز هفته شروع می‌شه.
اگر می‌خوای کنسل کنی این قابلیت رو می‌تونی به بخش رزرو دستی داخل بات مراجعه کنی.
"""
manual_reserve_select_food_canceled = """انتخاب غذا لغو شد!"""
manual_reserve_select_food_done = """در حال رزرو غذاها برای شما ..."""