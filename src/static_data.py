...
MANUAL_RESERVE_LABEL = "رزرو دستی غذا"
MANUAL_RESERVE_REGEX = '^{}$'.format(MANUAL_RESERVE_LABEL)
...
RESERVE_MENU_CHOICES = [
    [SET_USERNAME_AND_PASSWORD_LABEL, ACTIVATE_AUTOMATIC_RESERVE_LABEL, MANUAL_RESERVE_LABEL],
    [SET_FAVORITES_LABEL, SHOW_FAVORITES_LABEL],
    [BACK_TO_MAIN_MENU_LABEL]
]
